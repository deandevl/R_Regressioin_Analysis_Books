...
<div class="task">Task: Using `base::mean(), base::median(), stats::sd(), stats::cor()` functions to compute summary statistics for the *salary* variable from the *ceosal1* data set.</div>  
