...
The function `RregressPkg::ols_F_LM_calc()` provides a easy way to compute the $F$ value:
```{r}
mlb1_F_LM_lst <- RregressPkg::ols_F_LM_calc(
  df = mlb1,
...
```{r}
RplotterPkg::create_table(
  x = mlb1_F_LM_lst$F_LM_df,
  caption = "Reject Null Hypothesis: bavg = hrunsyr = rbisyr = 0",
  align_v = rep("c", 4),
  full_width = T
)
```
