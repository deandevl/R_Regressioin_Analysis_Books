...
Looking at the data set `wooldridge::wage1` which has a dummy variable for *female* of Example 7.1 `(Heiss)`.
...
```
A woman makes $1.81 per hour less than a man *with the same education, experience, and tenure*.

### Qualitative variable with 4 outcomes
Looking at at the data set `wooldridge::wage1` which has a qualitative variable that combines gender with martial status Example 7.2 `(Heiss)`.
