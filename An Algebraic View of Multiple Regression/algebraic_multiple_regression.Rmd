...
<div class="note">Note: See [RegressPkg::ols_regress_calc()](https://github.com/deandevl/RregressPkg) for the derivation of the OLS via matrix calculations.</div>
...
The `lm()` vs the `RregressPkg::ols_regress_calc()` versions:
```{r}
